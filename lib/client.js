      ...
      return h('div', { className: 'pmg-graph-overlay', onClick: (e) => { if (e.target === e.currentTarget) props.onClose() } },
        h('div', { className: 'pmg-graph-panel' },
          ...
          h('svg', {
            ...
            h('defs', null,
              h('marker', { id: 'pmg-arrow', viewBox: '0 0 10 10', refX: 9, refY: 5, markerWidth: 8.5, markerHeight: 8.5, orient: 'auto-start-reverse' },
            ...
            h('g', { transform: 'translate(' + view.tx + ',' + view.ty + ') scale(' + view.scale + ')' },
              graph.edges.map((e) => {
                ...
                return h('line', { key: e.from + '\u2192' + e.to, x1: p.x1, y1: p.y1, x2: p.x2, y2: p.y2, className: 'pmg-graph-edge', markerEnd: 'url(#pmg-arrow)' })
              }),
              nodePos.map((nd) => h('g', {
                key: nd.id, className: 'pmg-gnode', transform: 'translate(' + nd.x + ',' + nd.y + ')',
