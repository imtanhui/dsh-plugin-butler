    ...
    function MarketPanel(props) {
      ...
      return h('div', { className: 'pmg-market' },
        ...
        h('div', { className: 'pmg-market-list' },
          (props.items || []).map((it) => h('div', { key: it.fullName, className: 'pmg-mrow' },
    ...
    function PluginManagerTab(props) {
      ...
      return h('div', { className: 'pmg' },
        ...
        failedCount > 0
          ...
          : null,
        showMarket
          ? h(MarketPanel, { items: marketState.items, loading: marketState.loading, error: marketState.error, installing, onSearch: doMarketSearch, onDetailRepo: openDetailRepo, onInstall: doInstall })
          : null,
