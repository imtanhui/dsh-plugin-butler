window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      '.pmg-gnode-rect{fill:#1f2937;stroke:#111827;stroke-width:1}',
      '.pmg-gnode-rect.official{fill:#2563eb;stroke:#1d4ed8}',
      '.pmg-gnode-rect.external{fill:#1f2937;stroke:#111827}',
      '.pmg-gnode-name{font-size:11px;font-weight:600;fill:#ffffff}',
          ...
          h('svg', {
            ...
            h('g', { transform: 'translate(' + view.tx + ',' + view.ty + ') scale(' + view.scale + ')' },
              ...
              laidOut.nodes.map((nd) => h('g', {
                ...
                h('text', { y: 0, textAnchor: 'middle', dominantBaseline: 'central', className: 'pmg-gnode-name' }, nd.proj),
              )),
            ),
          ),
