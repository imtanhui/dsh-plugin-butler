/**
 * dsh-plugin-butler 纯函数工具：补丁文件手术式编辑 + GitHub 仓库解析 + 短名。
 * 不依赖 node:fs，便于单测。
 * @module dsh-plugin-butler/patch
 */
...
export function initialPatchFile() {
  return [
    '# dsh-plugin-butler（插件管家）管理的启停补丁 —— 修改后实时热生效。',
...
/** 从 repository 字段提取 owner/repo；非 GitHub 返回 null。 */
export function githubFullName(repository) {
